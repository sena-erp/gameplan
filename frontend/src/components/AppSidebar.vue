<template>
  ...
  >
    <div class="flex flex-col px-2 py-2">
      <a
        href="/desk"
        class="mb-1 flex w-[14rem] items-center rounded-md px-2 py-2 text-left text-ink-gray-7 hover:bg-surface-gray-3"
        aria-label="Home"
        title="Home"
      >
        <span class="lucide-home h-4 w-4 text-ink-gray-6" />
