          ...
          >
            <div class="w-full min-w-0">
              ...
              <div class="ml-6.5 mt-1.5 flex items-center">
                ...
                <div class="hidden min-w-0 items-center @md:flex" v-if="d.journey_milestone">
                  <div class="px-2 leading-none text-ink-gray-5">&middot;</div>
                  <div
                    class="flex min-w-0 items-center rounded bg-surface-gray-2 px-1.5 py-0.5 text-base leading-none text-ink-gray-6"
                  >
                    <span class="lucide-flag h-3 w-3 shrink-0 text-ink-gray-5" />
                    <span class="ml-1.5 overflow-hidden text-ellipsis whitespace-nowrap">
                      {{ d.journey_milestone_title || d.journey_milestone }}
                    </span>
                  </div>
                </div>
...
type TaskListItem = GPTask & {
  project_title?: string
  journey_milestone_title?: string
}
...
const tasks = useList<TaskListItem>({
  url: '/api/v2/method/gameplan.gameplan.doctype.gp_task.gp_task.get_list',
  doctype: 'GP Task',
  fields: [
    '*',
    'project.title as project_title',
    'journey_milestone.title as journey_milestone_title',
  ],
