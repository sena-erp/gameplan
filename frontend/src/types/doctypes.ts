...
export interface GPTask extends DocType {
  ...
  project?: string
  /** Journey Milestone: Link (GP Journey Milestone) */
...
// Last updated: 2026-06-03 00:00:00.000000
export interface GPJourney extends DocType {
  /** Title: Data */
  title: string
...
// Last updated: 2026-06-03 00:00:00.000000
export interface GPJourneyMilestone extends DocType {
  /** Title: Data */
  title: string
  /** Journey: Link (GP Journey) */
  journey: string
  /** Space: Link (GP Project) */
  project?: string
  /** Lane: Data */
